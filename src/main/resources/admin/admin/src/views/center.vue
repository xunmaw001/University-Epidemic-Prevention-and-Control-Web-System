  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='jiaoshi'"  label='学院' prop="xuanyuanTypes">
                 <el-select v-model="ruleForm.xuanyuanTypes"  placeholder='请选择学院'>
                     <el-option
                             v-for="(item,index) in xuanyuanTypesOptions"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xuexiao'"  label='学校管理员姓名' prop="xuexiaoName">
               <el-input v-model="ruleForm.xuexiaoName"  placeholder='学校管理员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='xuexiao'" label='头像' prop="xuexiaoPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xuexiao'"  label='电子邮箱' prop="xuexiaoEmail">
               <el-input v-model="ruleForm.xuexiaoEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='xueyuan'"  label='学院管理员姓名' prop="xueyuanName">
               <el-input v-model="ruleForm.xueyuanName"  placeholder='学院管理员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='xueyuan'" label='头像' prop="xueyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
                         :multiple="true"
                         :fileUrls="ruleForm.xueyuanPhoto?$base.url+ruleForm.xueyuanPhoto:''"
                         @change="xueyuanPhotoUploadChange"
                 ></file-upload>
             </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='xueyuan'"  label='联系方式' prop="xueyuanPhone">
               <el-input v-model="ruleForm.xueyuanPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='xueyuan'"  label='学院' prop="xuanyuanTypes">
                 <el-select v-model="ruleForm.xuanyuanTypes"  placeholder='请选择学院'>
                     <el-option
                             v-for="(item,index) in xuanyuanTypesOptions"
                             v-bind:key="item.codeIndex"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='宿舍号' prop="yonghuSuse">
               <el-input v-model="ruleForm.yonghuSuse"  placeholder='宿舍号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='学院' prop="xuanyuanTypes">
                 <el-select v-model="ruleForm.xuanyuanTypes"  placeholder='请选择学院'>
                     <el-option
                             v-for="(item,index) in xuanyuanTypesOptions"
                             v-bind:key="item.codeIndex"
...
// 注册表 学院管理员 的级联表
   ...
   this.$http({
       url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=xuanyuan_types`,
       method: "get"
   }).then(({ data }) => {
       if (data && data.code === 0) {
          this.xuanyuanTypesOptions = data.data.list;
      } else {
          this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.xuanyuanTypes)&& 'jiaoshi'==this.flag){
                         ...
                         if((!this.ruleForm.xueyuanName)&& 'xueyuan'==this.flag){
                             this.$message.error('学院管理员姓名不能为空');
                             return
                         }
                         ...
                         if((!this.ruleForm.xueyuanPhone)&& 'xueyuan'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }
                         ...
                         if((!this.ruleForm.xuanyuanTypes)&& 'xueyuan'==this.flag){
                             this.$message.error('学院不能为空');
                             return
                         }
                         ...
                         if((!this.ruleForm.yonghuSuse)&& 'yonghu'==this.flag){
                             this.$message.error('宿舍号不能为空');
                             return
                         }

                         if((!this.ruleForm.xuanyuanTypes)&& 'yonghu'==this.flag){
                             this.$message.error('学院不能为空');
                             return
                         }
