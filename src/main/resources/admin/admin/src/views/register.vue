    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校疫情防控注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="学校管理员姓名" class="input" v-if="tableName=='xuexiao'">
                            <el-input v-model="ruleForm.xuexiaoName" autocomplete="off" placeholder="学校管理员姓名"  />
                        </el-form-item>
                        ...
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='xuexiao'">
                            <el-input v-model="ruleForm.xuexiaoEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
                        <el-form-item label="学院管理员姓名" class="input" v-if="tableName=='xueyuan'">
                            <el-input v-model="ruleForm.xueyuanName" autocomplete="off" placeholder="学院管理员姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='xueyuan'">
                            <el-input v-model="ruleForm.xueyuanPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/gaoxiaoyiqingfangkong/img/back-img-bg.jpg);
