...
//                            xuexiaoEntity.setXuexiaoName(data.get(0));                    //学校管理员姓名 要改的
//                            xuexiaoEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            xuexiaoEntity.setXuexiaoPhoto("");//详情和图片
//                            xuexiaoEntity.setXuexiaoPhone(data.get(0));                    //联系方式 要改的
//                            xuexiaoEntity.setXuexiaoEmail(data.get(0));                    //电子邮箱 要改的
...
//                            xuexiaoEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(xuexiao.getId(),username, "xuexiao", "学校管理员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","学校管理员");
...
//    	ValidatorUtils.validateEntity(user);
    ...
    public R resetPass(String username, HttpServletRequest request) {
        ...
        if(xuexiao!=null){
            xuexiao.setPassword("123456");
            boolean b = xuexiaoService.updateById(xuexiao);
            if(!b){
               return R.error();
            }
            return R.ok();
